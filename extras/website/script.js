...
(function () {
  ...
  const DOWNLOAD_CONFIG = {
    ...
    windows: {
      ...
      installerFile: "portfolio_0.1.0_x64_setup.exe",
      installerUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_x64_setup.exe",
      portableUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_windows-x64_portable.zip",
    ...
    macos: {
      ...
      installerFile: "portfolio_0.1.0_universal.dmg",
      installerUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_universal.dmg",
      portableUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_macos-universal.zip",
    ...
    linux: {
      ...
      installerFile: "portfolio_0.1.0_amd64.deb",
      installerUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_amd64.deb",
      portableUrl: "https://github.com/your-username/portfolio/releases/download/v0.1.0/portfolio_0.1.0_linux-x64.tar.gz",
      terminalCmd: "sudo dpkg -i portfolio_0.1.0_amd64.deb",
      iconSvg: `<svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
