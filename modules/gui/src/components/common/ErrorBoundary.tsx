...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public override render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-[#07090e] text-slate-100 flex items-center justify-center p-6 font-mono select-none">
          <div className="max-w-md w-full bg-slate-900/90 border border-rose-900/50 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl text-center space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-[#6366f1] hover:bg-[#c82f63] text-white font-semibold text-xs rounded-xl shadow-lg shadow-[#6366f1]/25 flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
