      ...
      <div className="flex items-center justify-between gap-3 pb-3 border-b border-slate-800 shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-[#6366f1] transition-colors cursor-pointer focus:outline-none"
      ...
      <div className="flex-1 min-h-[500px] h-[calc(100vh-160px)] relative rounded-2xl overflow-hidden border border-slate-800 bg-[#131722] shadow-2xl flex flex-col">
        ...
        {loadFailed && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 text-center space-y-4 bg-[#07090e]">
            <div className="w-12 h-12 rounded-2xl bg-[#6366f1]/10 border border-[#6366f1]/30 flex items-center justify-center text-[#6366f1]">
            ...
            <div className="max-w-md space-y-1">
              ...
              <p className="text-xs text-slate-400">
                Could not connect to <code className="text-[#6366f1]">{termsUrl}</code>.{" "}
                {isLocalhost
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <button
                type="button"
                onClick={handleOpenBrowser}
                className="px-4 py-2 bg-[#6366f1] hover:bg-[#6366f1]/90 text-white rounded-lg text-xs font-semibold transition-colors cursor-pointer inline-flex items-center gap-1.5"
              >
