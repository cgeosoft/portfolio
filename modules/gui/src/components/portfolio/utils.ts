export { fmtCurrency, formatMoney, fmtPercent } from "portfolio-shared/format";
 ...
 * and ` response` close tags, tracking nesting depth.
...
export function cleanThinkTags(text: string | undefined, isReport = false): string {
  ...
  // If leading garbage/CJK artifact exists before the first header "#" or "1." in reports, strip it
...
/**
 * Single-pass state machine to strip ` thinking... response` blocks.
