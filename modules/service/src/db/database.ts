...
import { getDatabaseFile } from "../paths";
...
function initializeSchema(database: Database): void {
  ...
  // Login sessions (cookie id -> expiry) and small expiring counters such as
  // the PIN attempt limit (see ../services/auth.ts).
  database.run(`
